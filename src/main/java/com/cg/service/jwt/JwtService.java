...
public class JwtService {
    private static final String SECRET_KEY = "QWERTYUIOPASDFGHJKLZXCVBNM1234567890qwertyuiopasdfghjklzxcvbnm0987654321";
    ...
    public String generateTokenLogin(Authentication authentication) {
        ...
        return Jwts.builder()
                ...
                .setExpiration(new Date((new Date()).getTime() + JWT_TOKEN_VALIDITY * 60 * 60 * 60 * 3))
